  ...
  const getPageNumbers = () => {
    ...
    if (calculatedTotalPages <= maxVisible) {
      ...
      if (pagination.page <= halfVisible + 1) {
        ...
        pages.push(1);
        pages.push('ellipsis');
        for (let i = pagination.page - halfVisible + 1; i <= pagination.page + halfVisible - 1; i++) {
          pages.push(i);
        }
        pages.push('ellipsis');
        pages.push(calculatedTotalPages);
          ...
          <PaginationContent className="flex-wrap justify-center gap-1">
            <PaginationItem>
              <PaginationPrevious 
                ...
                className={paginationMeta.isFirstPage ? "pointer-events-none opacity-50" : "cursor-pointer"}
              />
            </PaginationItem>
            ...
            <PaginationItem>
              <PaginationNext 
                ...
                className={paginationMeta.isLastPage ? "pointer-events-none opacity-50" : "cursor-pointer"}
              />
            </PaginationItem>
          </PaginationContent>
        </Pagination>
